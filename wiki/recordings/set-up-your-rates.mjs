...
// My Rates sub-tab → edit the labour rate on camera → cabinet cards re-price.
...
export async function record(page, meta) {
  ...
  // 2. Pick a quote; its cabinets load priced and the sub-tabs appear.
  ...
  // 5. The cabinet cards re-price from the new rate — the money shot.
