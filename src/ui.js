...
function _renderProjectHeader(_domain, opts) {
  ...
  return `<div class="project-header">
    <div class="ph-row1">
      <button class="ph-back" onclick="${exitFn}();window._mvShowList&&window._mvShowList()" title="Back" aria-label="Back">
...
// F6 (2026-05-13): _renderProjectEmpty removed alongside the projects entity.
// Callers inline their own client-keyed empty state HTML.
