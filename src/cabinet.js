...
function cbDefaultLine(type) {
  ...
  return {
    ...
    baseType: 'plinth',
    // Material fields start blank — the maker picks from their own stock.
    // An empty/unknown name prices as £0 in calcCBLine, so nothing is
    // silently costed against a material the user never chose.
    material: '',
    backMat: '',
